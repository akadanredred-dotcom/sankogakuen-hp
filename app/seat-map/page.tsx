...
// 学校ごとの座席データ（1階・2階の割り当て情報と個別画像）
// 順番：1番目=seat6.jpg, 2番目=seat7.jpg, 3番目=seat8.jpg, 4番目=seat9.jpg, 5番目=seat10.jpg
type SchoolData = {
  name: string;
  color: string;
  description: string;
...
export default function SeatMapPage() {
  ...
  // 未選択時は全体図（seat4.jpg）、選択時は各学校の画像を表示
